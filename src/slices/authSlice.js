...
const authSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(getProductListApi.pending, (state) => {
                state.loading = true;
                state.error = null;
            })
            ...
            .addCase(getCategoryListApi.pending, (state) => {
                state.loading = true;
                state.error = null;
            })
            .addCase(getCategoryListApi.fulfilled, (state, action) => {
                state.loading = false;
                state.category = action.payload;
            })
            .addCase(getCategoryListApi.rejected, (state, action) => {
                state.loading = false;
                state.error = action.payload;
            })
            ...
            .addCase(skillUpdateApi.pending, (state) => {
                state.loading = true;
                state.error = null;
            })
            .addCase(skillUpdateApi.fulfilled, (state, action) => {
                state.loading = false;
                state.userSkill = state.userSkill.map((skill) =>
                    skill.id === action.payload.id ? action.payload : skill
                );
            })
            .addCase(skillUpdateApi.rejected, (state, action) => {
                state.loading = false;
                state.error = action.payload;
            })
            ...
            .addCase(categoryUpdateApi.rejected, (state, action) => {
                state.loading = false;
                state.error = action.payload;
            })
            ...
            .addCase(productUpdateApi.rejected, (state, action) => {
                state.loading = false;
                state.error = action.payload;
            })
        ;
